...
export default function CardInfos(): React.JSX.Element {
  return (
    <div className="card-infos">
      ...
      <div>
        <p>Cette carte n’a pas la prétention d’être exhaustive, face à la multitude d’initiatives, parfois éphémères, qui fleurissent sur le territoire. Elle sera enrichie au fil du temps, grâce à vos contributions !</p>
